...
public class JavaDb {
    ...
    public void addStudent(int id, String name, String mark) throws SQLException {
        String sql = "INSERT INTO student (student_id, name, grade) VALUES (?, ?, ?)";
    ...
    public void updateStudent(int id, String newName, String newMark) throws SQLException {
        String sql = "UPDATE student SET name = ?, grade = ? WHERE student_id = ?";
        try (PreparedStatement pstmt = connection.prepareStatement(sql)) {
            pstmt.setString(1, newName);
            pstmt.setString(2, newMark);
            pstmt.setInt(3, id);
    ...
    public void setMarks(int studentId,double marks) throws SQLException {
        ...
        String checkSql = "SELECT record_id FROM student WHERE student_id = ?";
